...
<div class="text-center mt-5">
	<form class="form-signin" action="index.php" method="post">
		...
		<input class="form-control" type="text" name="id_connect" id="id_connect" <?php if(isset($_COOKIE['pseudo'])){ echo 'value=' . $_COOKIE['pseudo'];}?> maxlength="255" required autofocus/></p>
