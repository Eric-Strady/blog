...
<div class="row mt-3 mb-4">
	...
	?>
			<p><form action="index.php" method="POST">
		 		<button class="btn btn-lg btn-dark" type="submit" formaction="http://127.0.0.1/blog/index.php?link=account&form=delete">Supprimer son compte</button>
			</form></p>
	<?php
		}
	?>
